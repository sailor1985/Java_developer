...
public class QueryBuilder {
    ...
    public String buildInsertQuery(Object obj) throws IllegalAccessException {
        ...
        if (clazz.isAnnotationPresent(Table.class)) {
            ...
            for (Field field : fields) {
                if (field.isAnnotationPresent(Colomn.class)) {
                    Colomn columnAnnotation = field.getAnnotation(Colomn.class);
    ...
    public String buildSelectQuery(Class<?> clazz, UUID primaryKey) {
        ...
        if (clazz.isAnnotationPresent(Colomn.class)) {
            Table tableAnnotation = clazz.getAnnotation(Table.class);
