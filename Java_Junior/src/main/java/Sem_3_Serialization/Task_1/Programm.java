...
Задача 2
Десериализуйте объект из ранее созданного файла обратно в объект Java, используя ObjectInputStream в сочетании с FileInputStream.
...
public class Programm {
    static void main() throws IOException, ClassNotFoundException {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream("userdata.bin")) {
            ...
            System.out.println("Объект " + user.getClass().getSimpleName() + " сериализован");
        }
        ...
        System.out.println("Объект " + user.getClass().getSimpleName() + " десериализован");
        System.out.println("Имя: " + user.getName());
        System.out.println("Возраст: " + user.getAge());
        System.out.println("Пароль (должен быть null, т.к. trancient): " + user.getPassword());
    }
}
